...
//!
//! Parses ssyswitch:// URLs into DeepLinkImportRequest structures.
...
/// Parse a ssyswitch:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// ssyswitch://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "ssyswitch" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'ssyswitch', got '{scheme}'"
        )));
    }
